...
The index and every brief are fully responsive. Open the live link above in your mobile
browser, then use **Add to Home Screen** (Safari: Share → Add to Home Screen; Chrome: menu →
Add to Home Screen) to get one-tap access like a native app.
